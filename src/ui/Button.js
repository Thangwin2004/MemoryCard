  ...
  constructor(text, onClick, currentR = 30) {
    ...
    this.label = new Text({
      ...
      style: {
        ...
        fill: "#ffffff",
        fontWeight: "900",
        stroke: { color: "#6e0912", width: 5, join: "round" },
        dropShadow: { color: "#4a000a", alpha: 1, distance: 3, blur: 0 },
      },
    });
    ...
    btnGrad.addColorStop(0, "#ff6b8b");
    btnGrad.addColorStop(0.35, "#ff1a40");
    btnGrad.addColorStop(1, "#d32f2f");
...
export class IconBtn extends Container {
  constructor(
    ...
    if (ICONS[iconName]) {
      ...
      // Dùng text/emoji nếu không có icon
      ...
      this.iconText.y = 0;
      this.content.addChild(this.iconText);
    }
